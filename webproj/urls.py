...
from app.views.fight.fight_view import pokemon_selection_view, get_strongest_match, get_weakest_match
...
from app.views.geral_view import apply_spin_rules_view
...
urlpatterns = [
    ...
    path('battle/strongest-match/', get_strongest_match, name='get_strongest_match'),
    path('battle/weakest-match/', get_weakest_match, name='get_weakest_match'),
    ...
    path('apply-spin/', apply_spin_rules_view, name='apply_spin_rules'),
